...
# HTML template for webpage(could be saved in a seperate file in future)
...
if wlan.status() != 3:
    ...
    print('IP address: ', network_info[0]) # Note: what do other elements of this array(I think it's an array) hold?
...
while True:
    try:
        ...
        # Recieve and parse the request
        request = conn.recv(1024)
        request = str(request)
        print('Requesst content = %s' % request)
        ...
        # Send he HTTP response and close the connection
