...
class ServoedJoint:
    ...
    def __init__ (self, em: EncodedMotor, startPos: int, p, i, d):
        ...
        self.velPid = PIDController(0.05, 0, 0)
    ...
    # Method to drive joint at velocity
    def driveJointVel(self, v: int, modifier):
        vel = v * 2.5
        limited = False
        ...
        # drive motor from PID loop with offset for feed forward or other modifications
        val = ( self.velPid.updatePID(vel, self.getVelocity()) + modifier)
        self.motor.setOutput( val)
