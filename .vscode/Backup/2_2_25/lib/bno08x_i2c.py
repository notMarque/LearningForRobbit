...
class BNO08X_I2C:
    ...
    def stability_classification(self):
        ...
        * "Stationary" -  The sensor’s motion is below the stable threshold but\r
        the stable duration requirement has not been met. This output is only available when\r
    ...
    def activity_classification(self):
        """Returns the sensor's assessment of the activity that is creating the motions\r
